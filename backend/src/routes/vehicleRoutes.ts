...
// Order matters: list search/transactions first, otherwise they get treated as /:id
router.get('/search', authenticateToken as any, searchVehicles as any);
router.get('/transactions', authenticateToken as any, requireAdmin as any, listTransactions as any);
